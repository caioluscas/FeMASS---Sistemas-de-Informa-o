...
#impressão em tela de ponto flutuante com precisão simples
 #$f12 registrador especializado para impressão em ponto flutuante (single ou doubl

20: #lwc1 instrução para carregamento de dados de memória em ponto flutuante (single ou double)
 ...
 # Instrução para encontrar o valor absoluto em ponto flutuante com precisão simple
